...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public enum EffectType
        {
            ...
            EFFECT_PEDS_SPAWN_ANGRY_NAKED_MAN,
            EFFECT_SPAWN_FAN_GIRLS,
            EFFECT_SPAWN_KOSATKA,
            EFFECT_SPAWN_FREIGHT,
            EFFECT_SPAWN_ARMORED_KURUMA,
            EFFECT_SPAWN_COMPANION_UBER_CHIMP,
            EFFECT_SPAWN_HANDLER,
            EFFECT_SPAWN_HOTTUB,
            EFFECT_HOT_COUGARS,
            EFFECT_VEHS_BEDMOBILE,
            EFFECT_PEDS_SERIOUS_KAMIKAZES,
            EFFECT_SPAWN_FAN_HENS,
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
            ...
            {EffectType.EFFECT_PLAYER_POOR, new EffectInfo("Poor Boy", EffectCategory.PLAYER, "poorboi")},
            ...
            {EffectType.EFFECT_PLAYER_AUTOPILOT, new EffectInfo("Autopilot", EffectCategory.PLAYER, "player_break", true, true)},
            ...
            {EffectType.EFFECT_PEDS_PORTAL_GUN, new EffectInfo("Portal Guns", EffectCategory.PEDS, "peds_portal_gun", true)},
            ...
            {EffectType.EFFECT_VEH_BOUNCY,  new EffectInfo("Bouncy Vehicles", EffectCategory.VEHICLE, "veh_bouncy", true, false)},
            ...
            {EffectType.EFFECT_VEHS_WIZARD_BROOM, new EffectInfo("You're A Wizard, Franklin", EffectCategory.VEHICLE, "vehs_spawn_wizard_broom")},
            ...
            {EffectType.EFFECT_PEDS_SPAWN_ANGRY_NAKED_MAN, new EffectInfo("Spawn Angry Naked Man", EffectCategory.PEDS, "peds_spawn_angry_naked_man")},
            {EffectType.EFFECT_SPAWN_FAN_GIRLS, new EffectInfo("Spawn Fan Girls", EffectCategory.PEDS, "peds_spawnfangirls")},
            {EffectType.EFFECT_SPAWN_TOWING_TONYA, new EffectInfo("Spawn Towing Tonya", EffectCategory.PEDS, "peds_towingtonya")},
            {EffectType.EFFECT_SPAWN_KOSATKA, new EffectInfo("Spawn Kosatka", EffectCategory.VEHICLE, "spawn_kosatka")},
            {EffectType.EFFECT_SPAWN_FREIGHT, new EffectInfo("Spawn Freight", EffectCategory.VEHICLE, "spawn_freight")},
            {EffectType.EFFECT_SPAWN_ARMORED_KURUMA, new EffectInfo("Spawn Armored Kuruma", EffectCategory.VEHICLE, "spawn_armored_kuruma")},
            {EffectType.EFFECT_SPAWN_COMPANION_UBER_CHIMP, new EffectInfo("Spawn Companion Uber Chimp", EffectCategory.PEDS, "spawn_uber_chimp")},
            {EffectType.EFFECT_SPAWN_HANDLER, new EffectInfo("Spawn Handler", EffectCategory.VEHICLE, "spawn_handler")},
            {EffectType.EFFECT_SPAWN_HOTTUB, new EffectInfo("Spawn Twitch Streamer", EffectCategory.MISC, "misc_spawn_hottub")},
            ...
            {EffectType.EFFECT_SPAWN_FAN_HENS, new EffectInfo("I Love Cocks", EffectCategory.PEDS, "peds_spawnfanhens")},
            {EffectType.EFFECT_EXTREME_WHALE_RAIN, new EffectInfo("Secret Extreme Whale Rain", EffectCategory.MISC, "world_extremewhalerain", true, true)},
