namespace ConfigApp
{
    public static class Effects
    {
        ...
        public static readonly Dictionary<string, EffectInfo> EffectsMap = new()
        {
            ...
            { "tp_mazebanktower", new EffectInfo("Teleport Onto Maze Bank Tower", EffectCategory.Player) },
            ...
            { "veh_randomseat", new EffectInfo("Set Player Into Random Seat", EffectCategory.Player) },
            ...
            { "peds_a_bad_year", new EffectInfo("A Bad Year", EffectCategory.Peds, true) },
            { "player_bob_the_builder", new EffectInfo("Bob The Builder", EffectCategory.Player, true) },
            ...
            { "peds_blue_balls", new EffectInfo("BlueBall%", EffectCategory.Peds, true) },
            { "peds_bore_ragnarok", new EffectInfo("Bore Ragnarok", EffectCategory.Peds, true) },
            ...
            { "peds_were_getting_the_band_back_together", new EffectInfo("The Band Is Back Together", EffectCategory.Peds) },
            { "peds_womanizer", new EffectInfo("Womanizer", EffectCategory.Peds) },
            { "peds_peaceful_protest", new EffectInfo("Peaceful Protest", EffectCategory.Peds, true) },
            { "player_axe_body_spray", new EffectInfo("Axe Body Spray", EffectCategory.Player, true) },
            { "player_becomes_flying_animal", new EffectInfo("Player Becomes Flying Animal", EffectCategory.Player, true, true) },
            { "player_becomes_land_animal", new EffectInfo("Player Becomes Land Animal", EffectCategory.Player, true, true) },
            { "player_becomes_water_animal", new EffectInfo("Become Sea Animal In Water", EffectCategory.Player, true, true) },
            ...
            { "player_orbital_strike", new EffectInfo("Orbital Strike", EffectCategory.Player) },
            { "player_randomize_player_clothes", new EffectInfo("Clothes Randomizer", EffectCategory.Player, true) },
            { "player_shoulder_swap", new EffectInfo("Shoulder Swap", EffectCategory.Player, true) },
            { "player_walking_speed_100x", new EffectInfo("Slide Walk", EffectCategory.Player, true) },
            { "player_what_if_i_was_the_hitman_all_along", new EffectInfo("What If I'm The Hitman?", EffectCategory.Player) },
            ...
            { "screen_chat_control_camera", new EffectInfo("Chat Controls Camera", EffectCategory.Screen, true) },
