...
struct PedSpawnAttributes
{
	...
	PedSpawnAttributes(int _weapon, int _relation) : weapon(_weapon), relationship(_relation)
	{
	}
};
...
static const std::vector<FakeSpawnInfo> fakeSpawns = {
	...
	{ "spawn_grieferjesus", 0xCE2CB751, FakeSpawnType::PEDTYPE,
	  new PedSpawnAttributes(0x6D544C99, 5) },                                                       // Griefer Jesus
...
static void OnStart()
{
	...
	CurrentEffect::OverrideEffectNameFromId(overideId);
