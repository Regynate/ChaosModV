...
const char *ROULETTE_WORDS[] = { "ROCKSTAR", "PONGO123", "DRUNDER_", "LAST0XYG", "TAKE_TWO", "DAVEYYYY", "MWEATHER",
	                             "RED_DEAD", "CHAOSMOD", "HACKING!", "ALXBLADE", "DVIPERAU", "HCKERMAN", "BURHAC!!", 
				     "TOASTYYY", "KOLYA_VE", "LU7YOSHI", "P.BIDDLE", "SLOTHBEE", "JUHANA!!", "BYHEMECH", 
				     "$$WASTED", "MO_11___", "{RANDOM}", "ROULETTE", "PASS1234", "/HACK_R*", "FRANKLIN", 
				     "MICHAEL_", "TREVOR__", "LESTER__", "SYNFETIC", "__KBOX__", "ZPG__ZPG", "_REGUAS_",
				     "1BASSIE_", "JXLEMMON"
			       };
...
const char *WIN_PHRASES[]    = { "Rockstar: Creating realistic hacking since 1998.",
			      ...
			      "ZPG is a load of shit",
			      "ZPG is the greatest in the world" };
