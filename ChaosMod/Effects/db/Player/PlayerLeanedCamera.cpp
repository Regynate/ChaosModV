...
static RegisterEffect registerEffect(EFFECT_LEANED_CAMERA, OnStart, OnStop, OnTick, EffectInfo
	{
		...
		.IncompatibleWith = { EFFECT_PLAYER_QUAKE_FOV, EFFECT_PLAYER_GTA_2, EFFECT_PLAYER_BINOCULARS, EFFECT_PLAYER_ZOOMZOOM_CAM, EFFECT_FLIP_CAMERA, EFFECT_PLAYER_SICK_CAM }
	}
);