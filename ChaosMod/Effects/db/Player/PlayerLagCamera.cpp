...
static RegisterEffect registerEffect(EFFECT_PLAYER_LAGGY_CAMERA, OnStart, OnStop, OnTick, EffectInfo
	{
		...
		.IsTimed = true,
		.IncompatibleWith = { EFFECT_PLAYER_BINOCULARS, EFFECT_FLIP_CAMERA, EFFECT_PLAYER_GTA_2, EFFECT_PLAYER_QUAKE_FOV, EFFECT_LEANED_CAMERA, EFFECT_PLAYER_SPIN_CAMERA, EFFECT_PLAYER_ZOOMZOOM_CAM, EFFECT_MISC_NEWS_TEAM }
	}
);