...
namespace Memory
{
	enum eMenuPref
	{
		...
		PREF_VID_ASPECT,
		PREF_VID_VSYNC,
		PREF_VID_STEREO,                            // REQUIRES RESTART
		PREF_VID_STEREO_CONVERGENCE,
		PREF_VID_STEREO_SEPARATION,
		PREF_VID_PAUSE_ON_FOCUS_LOSS,

		PREF_GFX_DXVERSION,                         // REQUIRES RESTART

		PREF_GFX_TEXTURE_QUALITY,                   // REQUIRES RESTART
		PREF_GFX_SHADER_QUALITY,                    // REQUIRES RESTART
		PREF_GFX_SHADOW_QUALITY,
		PREF_GFX_REFLECTION_QUALITY,
		PREF_GFX_REFLECTION_MSAA,
		PREF_GFX_WATER_QUALITY,
		PREF_GFX_PARTICLES_QUALITY,                 // REQUIRES RESTART
		PREF_GFX_GRASS_QUALITY,                     // REQUIRES RESTART
